...
class ContactManager extends ChangeNotifier {
  ...
  ContactModel? _contactObject = ContactModel(id: '1', name: 'test', number: '123');
  ContactModel? get contactObject => _contactObject;
  ...
  Future<void> getContactByIdObject(String id) async {
    loading = true;
    _contactObject = (await service.fetchByIdContact(id));
    loading = false;
    notifyListeners();
  }
}
